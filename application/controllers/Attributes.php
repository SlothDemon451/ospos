...
class Attributes extends Secure_Controller
{
	...
	private function get_attributes($definition_flags = 0)
	{
		...
		foreach (ItemAttribute::get_definition_flags() as $id => $term)
		{
	...
	public function view($definition_id = NO_DEFINITION_ID)
	{
		...
		$show_all = ItemAttribute::SHOW_IN_ITEMS | ItemAttribute::SHOW_IN_RECEIVINGS | ItemAttribute::SHOW_IN_SALES;
