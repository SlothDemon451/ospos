		...
		?>
			<tr>
				...
				<td>
					...
					<?php echo form_close(); ?>
					<a href="<?php echo site_url('sales/suspended_receipt/' . $suspended_sale['sale_id']); ?>" class="btn btn-success btn-xs" target="_blank" style="margin-right:5px;">
						<span class="glyphicon glyphicon-eye-open"></span>
					</a>
					<!-- Added: Suspended Receipt Without Tax -->
					<a href="<?php echo site_url('sales/suspended_receipt/' . $suspended_sale['sale_id'] . '?tax=0'); ?>" class="btn btn-warning btn-xs" target="_blank" title="Suspended Receipt Without Tax">
					<span class="glyphicon glyphicon-eye-open"></span>
					</a>
				</td>
			</tr>
