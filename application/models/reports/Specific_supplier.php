...
class Specific_supplier extends Report
{
	...
	public function getData(array $inputs)
	{
		...
		if($query === FALSE)
		{
			error_log('Specific_supplier getData query failed: ' . print_r($this->db->error(), TRUE));
			return array();
		}
	...
	public function getSummaryData(array $inputs)
	{
		...
		if($query === FALSE)
		{
			error_log('Specific_supplier getSummaryData query failed: ' . print_r($this->db->error(), TRUE));
			return array();
		}
