...
<?php echo form_open("receivings/save/".$receiving_info['receiving_id'], array('id'=>'receivings_edit_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="receiving_basic_info">
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('receivings_supplier'), 'supplier', array('class'=>'required control-label col-xs-3')); ?>
			<div class='col-xs-8'>
...
$(document).ready(function()
{
	...
	$('#receivings_edit_form').validate($.extend({
		...
		messages: {
			supplier_id: "<?php echo $this->lang->line('receivings_supplier_required'); ?>"
		}
	}, form_support.error));
});
</script>
