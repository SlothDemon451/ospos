...
class Customer extends Person
{
	...
	*/
	public function get_stats($customer_id)
	{
		...
		if($query === FALSE)
		{
			// Log DB error once and return sane defaults
			log_message('error', 'Customer::get_stats query failed for customer_id ' . $customer_id . ' - DB error: ' . print_r($this->db->error(), TRUE));
			$stat = NULL;
		}
		else
		{
