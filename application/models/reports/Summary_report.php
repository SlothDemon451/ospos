...
abstract class Summary_report extends Report
{
	...
	public function getData(array $inputs)
	{
		...
		if ($result === FALSE) {
			...
			log_message('error', 'Database query failed in Summary_report::getData: ' . $this->db->last_query());
	...
	public function getSummaryData(array $inputs)
	{
		...
		if ($result === FALSE) {
			// Log the error for debugging
			log_message('error', 'Database query failed in Summary_report::getSummaryData: ' . $this->db->last_query());
			return array(); // Return empty array instead of false
		}
