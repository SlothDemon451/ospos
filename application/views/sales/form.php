...
<?php echo form_open("sales/save/".$sale_info['sale_id'], array('id'=>'sales_edit_form', 'class'=>'form-horizontal')); ?>
	...
	<div class="form-group">
		<div class="col-xs-offset-3 col-xs-8">
			<button type="submit" class="btn btn-primary"><?php echo $this->lang->line('sales_update'); ?></button>
		</div>
	</div>
<?php echo form_close(); ?>
		...
		submitHandler: function(form) {
			$(form).ajaxSubmit({
				success: function(response) {
					var handled = false;
					try {
						if (typeof table_support !== 'undefined' && typeof table_support.handle_submit === 'function') {
							if (typeof dialog_support !== 'undefined' && typeof dialog_support.hide === 'function') {
								dialog_support.hide();
							}
