...
class Summary_suppliers extends Summary_report
{
	...
	protected function _select(array $inputs)
	{
		...
		$this->db->select('
				COALESCE(MAX(CONCAT(supplier_c.company_name, " (", supplier_p.first_name, " ", supplier_p.last_name, ")")), "No Supplier") AS supplier,
	...
	protected function _from()
	{
		...
		$this->db->join('suppliers AS supplier_c', 'items.supplier_id = supplier_c.person_id', 'left');
		$this->db->join('people AS supplier_p', 'items.supplier_id = supplier_p.person_id', 'left');
	}
