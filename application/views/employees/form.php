		...
		<div class="tab-pane fade in active" id="employee_basic_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">
					<!-- <label class="control-label col-xs-3">Is Delivery Man</label>
					<div class="col-xs-8">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="is_delivery_man" value="1" <?php echo isset($person_info->is_delivery_man) && $person_info->is_delivery_man ? 'checked' : ''; ?>>
								Yes
							</label>
						</div>
					</div> -->
