...
class Reports extends Secure_Controller
{
	...
	{
		$definition_names = $this->ItemAttribute->get_definitions_by_flags(ItemAttribute::SHOW_IN_SALES);
	...
	{
		$definition_names = $this->ItemAttribute->get_definitions_by_flags(ItemAttribute::SHOW_IN_RECEIVINGS);
