...
<?php if(!$is_embed) { $this->load->view('partial/print_receipt', array('print_after_sale'=>$print_after_sale, 'selected_printer'=>'receipt_printer')); } ?>
...
<?php
// Instead of always using the config, use the passed $receipt_template if set
$this->load->view("sales/" . (isset($receipt_template) ? $receipt_template : $this->config->item('receipt_template')));
?>
